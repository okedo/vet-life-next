...
for (var i = 0; i < l; i++) {
    images[i].addEventListener("click", function (i) {
        ...
        function prev() {
            prevImg = currentImg.parentElement.previousElementSibling.children[0];
            imgItem.innerHTML = '<img src="' + prevImg.src + '">';
            currentImg = currentImg.parentElement.previousElementSibling.children[0];
        ...
        function next() {
            nextImg = currentImg.parentElement.nextElementSibling.children[0];
            imgItem.innerHTML = '<img src="' + nextImg.src + '">';
            currentImg = currentImg.parentElement.nextElementSibling.children[0];
            var mainImg = document.querySelector(".gg-image > img").src;
